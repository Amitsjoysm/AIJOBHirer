...
```
Production:
https://deploy-prep-13.preview.emergentagent.com/auth/google/callback
...
```
Production:
https://deploy-prep-13.preview.emergentagent.com/auth/microsoft/callback
...
Response:
{
  ...
  "redirect_uri": "https://deploy-prep-13.preview.emergentagent.com/auth/google/callback",
...
Response:
{
  ...
  "redirect_uri": "https://deploy-prep-13.preview.emergentagent.com/auth/microsoft/callback",
