      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <div className="space-y-3 mb-6">
            <GoogleOAuthButton apiUrl={process.env.REACT_APP_BACKEND_URL} text="Sign up with Google" />
            <MicrosoftOAuthButton apiUrl={process.env.REACT_APP_BACKEND_URL} text="Sign up with Microsoft" />
          </div>
